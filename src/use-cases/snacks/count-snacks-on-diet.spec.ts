...
import { CountSnacksOnDietCase } from './count-snacks-on-diet'

let userRepository: InMemoryUsersRepository

let snackRepository: InMemorySnacksRepository
let sut: CountSnacksOnDietCase
...
describe('Count snacks on diet', () => {
  beforeEach(() => {
    ...
    sut = new CountSnacksOnDietCase(snackRepository, userRepository)
  })
